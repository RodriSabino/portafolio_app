import { c as createComponent, r as renderTemplate, a as addAttribute, d as renderHead, e as renderSlot, b as createAstro, m as maybeRenderHead, f as renderComponent } from '../chunks/astro/server_DI3ovVLK.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                 */
...
const basics = {
	name: "Rodrigo Alexander Sabino Ramirez",
	label: "Software Engineering Student | Full-Stack Developer | QA Specialist | Data Science Enthusiast",
	image: "/me.webp",
	email: "rodrigosabinoramirez@gmail.com",
	phone: "+51 981273313",
	url: "https://",
	summary: "Estudiante de 9no ciclo de Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas, con sólidos conocimientos en front-end (HTML, CSS, JavaScript, React JS, Angular) y experiencia en el desarrollo de aplicaciones móviles (Flutter, Kotlin). En el backend, manejo programación orientada a objetos con Node.js y Java, además de frameworks como Spring Boot y uso de SQL para consultas de bases de datos. Familiarizado con API REST y conocimientos básicos de Docker. Autodidacta, con habilidades para resolver problemas, comunicación efectiva y trabajo en equipo. ",
	location: {
		address: "",
		postalCode: "",
		city: "Callao, Callao",
	...
	profiles: [
		{
			network: "LinkedIn",
			username: "",
			url: "https://www.linkedin.com/in/rodsabino"
		},
		{
			network: "GitHub",
			username: "",
			url: "https://github.com/RodriSabino"
		}
	]
};
const work = [
	{
		name: "Visma",
		position: "QA Trainee",
		url: "https://latam.visma.com/es-pe/",
		startDate: "2024-01-02",
		endDate: "2024-01-02",
		summary: "Como QA Trainee en Visma, asumí la responsabilidad de diseñar casos de prueba, tanto manuales como automatizados, para certificar las funcionalidades de las aplicaciones. Estimé el tiempo necesario para la creación y ejecución de estos casos, garantizando un plan de trabajo preliminar efectivo. Ejecuté pruebas manuales y utilicé herramientas como Postman y Selenium para la automatización, cumpliendo con los plazos acordados y los compromisos con otras áreas. Esta experiencia me proporcionó una sólida comprensión de los procesos de aseguramiento de la calidad y una habilidad práctica en la ejecución de pruebas tanto manuales como automatizadas. ",
		highlights: [
			""
		]
	}
...
const education = [
	{
		...
		url: "https://pregrado.upc.edu.pe/facultad-de-ingenieria/ingenieria-de-software/",
...
const awards = [
	{
		title: "Beca 18",
		date: "2020-03-15",
		awarder: "Programa Nacional de Becas y Crédito Educativo | PRONABEC",
		summary: "Programa Nacional de Becas y Crédito Educativo | PRONABEC"
	}
];
const skills = [
	{
...
const projects = [
	{
		name: "FastPorte",
		isActive: true,
		description: "Plataforma web para servicios de transporte.",
		highlights: [
			"Angular JS",
			"Java SpringBoot",
			"Kotlin",
		...
		url: "https://github.com/orgs/Tech-Company-SW52/repositories",
		github: "https://github.com/orgs/Tech-Company-SW52/repositories"
	},
	{
		name: "TakeMeHome",
		isActive: false,
		description: "Plataforma web para envio de encomiendas",
		highlights: [
			"Vue JS",
			"ASP.NET",
			"MySQL"
		],
		url: "https://github.com/orgs/TakeMeHome-Del-mundo-a-tus-manos/repositories",
		github: "https://github.com/orgs/TakeMeHome-Del-mundo-a-tus-manos/repositories"
	},
	{
		name: "Profile+",
		isActive: true,
		description: "Plataforma web para encontrar Programadores",
		highlights: [
			"Angular JS",
			"Java SpringBoot",
			"MySQL"
		],
		url: "https://github.com/orgs/Diseno-de-experimentos-upc/repositories",
		github: "https://github.com/orgs/Diseno-de-experimentos-upc/repositories"
	},
	{
		name: "Machipet",
		isActive: false,
		description: "Aplicacion mobil para adopcion de mascotas",
		highlights: [
			"Flutter"
		],
		url: "https://github.com/orgs/Matchipet/repositories",
		github: "https://github.com/orgs/Matchipet/repositories"
	}
];
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/layouts/Layout.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/components/Section.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/components/sections/About.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/components/sections/Education.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/components/sections/Experience.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/Mail.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/Phone.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/X.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/LinkedIn.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/GitHub.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/WorldMap.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/components/sections/Hero.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/components/sections/Projects.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/html.astro", void 0);

const $$Css = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<svg width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M20 4l-2 14.5l-6 2l-6 -2l-2 -14.5z"></path><path d="M8.5 8h7l-4.5 4h4l-.5 3.5l-2.5 .75l-2.5 -.75l-.1 -.5"></path></svg>`;
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/css.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/javascript.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/type.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/react.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/node.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/sql.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/git.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/tailwind.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/next.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/swift.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/swiftui.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/kotlin.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/icons/flutter.astro", void 0);
...
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/components/sections/Skills.astro", void 0);

const $$Achievement = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "title": "Logros", "data-astro-cid-farspikf": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<ul data-astro-cid-farspikf> ${awards.map(({ title, date, awarder, summary }) => {
    const startYear = new Date(date).getFullYear();
    return renderTemplate`<li data-astro-cid-farspikf> <article data-astro-cid-farspikf> <header data-astro-cid-farspikf> <div data-astro-cid-farspikf> <h3 data-astro-cid-farspikf> <a${addAttribute(`Ver ${title}`, "title")} target="_blank" data-astro-cid-farspikf> ${title} </a> </h3> <h4 data-astro-cid-farspikf>${awarder}</h4> </div> <div data-astro-cid-farspikf> <time data-astro-cid-farspikf>${startYear}</time> </div> </header> </article> </li>`;
  })} </ul> ` })} `;
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/components/sections/Achievement.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  const { name, label } = basics;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": `Portafolio de ${name} - ${label}`, "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main data-astro-cid-j7pv25f6> ${renderComponent($$result2, "Hero", $$Hero, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "About", $$About, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "Experience", $$Experience, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "Education", $$Education, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "Achievement", $$Achievement, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "Projects", $$Projects, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "Skills", $$Skills, { "data-astro-cid-j7pv25f6": true })} </main> ` })}  `;
}, "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/pages/index.astro", void 0);

const $$file = "C:/Users/rodri/OneDrive/Documentos/Projects/portafolio_app/src/pages/index.astro";
const $$url = "";
